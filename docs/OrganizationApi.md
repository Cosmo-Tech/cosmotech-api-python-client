...
[**get_all_permissions**](OrganizationApi.md#get_all_permissions) | **GET** /organizations/permissions | Get the all permission by given role
...
with cosmotech_api.ApiClient(configuration) as api_client:
    ...
    api_instance = organization_api.OrganizationApi(api_client)
    organization_id = "organization_id_example" # str | the Organization identifier
    body = "commonrolewriter" # str | the new Organization default security.
