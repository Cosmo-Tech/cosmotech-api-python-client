...
[**query_data**](DatasetApi.md#query_data) | **GET** /organizations/{organization_id}/workspaces/{workspace_id}/datasets/{dataset_id}/parts/{dataset_part_id}/query | Get data of a Dataset
...
# **query_data**
> List[object] query_data(organization_id, workspace_id, dataset_id, dataset_part_id, filters=filters, sums=sums, counts=counts, offset=offset, limit=limit)
...
with cosmotech_api.ApiClient(configuration) as api_client:
    ...
    dataset_id = 'dataset_id_example' # str | the Dataset identifier
    dataset_part_id = 'dataset_part_id_example' # str | the Dataset part identifier
    filters = ['filters_example'] # List[str] | Property names that should be part of the response data. You can specify a property name like:  - id  - stock  - quantity  - ...  (optional)
    sums = ['sums_example'] # List[str] | Property names to sum by (optional)
    counts = ['counts_example'] # List[str] | Property names to count by (optional)
    offset = 56 # int | The query offset (optional)
    limit = 56 # int | The query limit (optional)

    try:
        # Get data of a Dataset
        api_response = api_instance.query_data(organization_id, workspace_id, dataset_id, dataset_part_id, filters=filters, sums=sums, counts=counts, offset=offset, limit=limit)
 ...
 **dataset_id** | **str**| the Dataset identifier | 
 **dataset_part_id** | **str**| the Dataset part identifier | 
 **filters** | [**List[str]**](str.md)| Property names that should be part of the response data. You can specify a property name like:  - id  - stock  - quantity  - ...  | [optional] 
 **sums** | [**List[str]**](str.md)| Property names to sum by | [optional] 
 **counts** | [**List[str]**](str.md)| Property names to count by | [optional] 
