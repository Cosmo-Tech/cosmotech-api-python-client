...
class TestScenarioChangedParameterValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScenarioChangedParameterValue:
        """Test ScenarioChangedParameterValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScenarioChangedParameterValue`
        """
        model = ScenarioChangedParameterValue()
        if include_optional:
            return ScenarioChangedParameterValue(
                parameter_id = '',
                var_type = '',
                value = '',
                compared_value = ''
