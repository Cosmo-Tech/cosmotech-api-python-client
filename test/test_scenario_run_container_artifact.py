...
class TestScenarioRunContainerArtifact(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScenarioRunContainerArtifact:
        """Test ScenarioRunContainerArtifact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScenarioRunContainerArtifact`
        """
        model = ScenarioRunContainerArtifact()
        if include_optional:
            return ScenarioRunContainerArtifact(
                name = '',
                path = ''
            )
        else:
