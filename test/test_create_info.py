...
class TestCreateInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateInfo:
        """Test CreateInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateInfo`
        """
        model = CreateInfo()
        if include_optional:
            return CreateInfo(
