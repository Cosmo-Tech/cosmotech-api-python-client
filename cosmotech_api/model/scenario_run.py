...
class ScenarioRun(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'state': (str,),  # noqa: E501
            'failed_step': (str,),  # noqa: E501
            'failed_container_id': (str,),  # noqa: E501
            ...
            'scenariorun_event_bus_resource_uri': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'failed_step': 'failedStep',  # noqa: E501
        'failed_container_id': 'failedContainerId',  # noqa: E501
        ...
        'scenariorun_event_bus_resource_uri': 'scenariorunEventBusResourceUri',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ScenarioRun - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            state (str): the ScenarioRun state. [optional]  # noqa: E501
            failed_step (str): the failed step if state is Failed. [optional]  # noqa: E501
            failed_container_id (str): the failed container Id if state is Failed. [optional]  # noqa: E501
            start_time (str): the ScenarioRun start Date Time. [optional]  # noqa: E501
            end_time (str): the ScenarioRun end Date Time. [optional]  # noqa: E501
            ...
            send_input_to_data_warehouse (bool): whether or not the Dataset values and the input parameters values are send to the DataWarehouse prior to ScenarioRun Run. [optional]  # noqa: E501
            data_warehouse_db (str): the DataWarehouse database name to send data if sendInputToDataWarehouse is set. [optional]  # noqa: E501
            results_event_bus_resource_uri (str): the event bus which receive Workspace ScenarioRun results messages. Message won't be send if this is not set. [optional]  # noqa: E501
            scenariorun_event_bus_resource_uri (str): the event bus which receive Workspace ScenarioRun events messages. Message won't be send if this is not set. [optional]  # noqa: E501
