...
class DatasetSecurity(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'access_control_list': ([DatasetAccessControl],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, default, access_control_list, *args, **kwargs):  # noqa: E501
        """DatasetSecurity - a model defined in OpenAPI

        Args:
            default (str): the role by default
            access_control_list ([DatasetAccessControl]): the list which can access this Dataset with detailed access control information
