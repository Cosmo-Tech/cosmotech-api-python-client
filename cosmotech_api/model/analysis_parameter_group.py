...
class AnalysisParameterGroup(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'parameters': ([AnalysisParameter],),  # noqa: E501
            'order': (int,),  # noqa: E501
    ...
    def __init__(self, id, labels, parameters, *args, **kwargs):  # noqa: E501
        """AnalysisParameterGroup - a model defined in OpenAPI

        Args:
            id (str): the Parameter Group id
            labels (TranslatedLabels):
            parameters ([AnalysisParameter]): a list of Simulator Analysis Parameters
        ...
        Keyword Args:
            ...
            parent_id (str): the Simulator Analysis Group parent Id. [optional]  # noqa: E501
        """
