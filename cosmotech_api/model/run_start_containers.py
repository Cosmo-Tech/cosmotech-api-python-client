...
class RunStartContainers(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, csm_simulation_id, containers, *args, **kwargs):  # noqa: E501
        """RunStartContainers - a model defined in OpenAPI

        Args:
            csm_simulation_id (str): Cosmo Tech Simulation Run Id
            containers ([RunContainer]): the containerslist
        ...
        Keyword Args:
            ...
            labels ({str: (str,)}): the workflow labels. [optional]  # noqa: E501
        """
