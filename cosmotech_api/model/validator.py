...
class Validator(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, repository, version, *args, **kwargs):  # noqa: E501
        """Validator - a model defined in OpenAPI

        Args:
            id (str): the Validator id
        ...
        Keyword Args:
            ...
            description (str): the Validator description. [optional]  # noqa: E501
            owner_id (str): the User id which own this Validator. [optional]  # noqa: E501
            url (str): an optional URL link to Validator page. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, repository, version, *args, **kwargs):  # noqa: E501
        """Validator - a model defined in OpenAPI
