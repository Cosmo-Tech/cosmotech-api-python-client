...
def lazy_import():
    from cosmotech_api.model.rbac_access_control import RbacAccessControl
    globals()['RbacAccessControl'] = RbacAccessControl


class OrganizationSecurity(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'access_control_list': ([RbacAccessControl],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, default, access_control_list, *args, **kwargs):  # noqa: E501
        """OrganizationSecurity - a model defined in OpenAPI

        Args:
            default (str): the role by default
            access_control_list ([RbacAccessControl]): the list which can access this Organization with detailed access control information
