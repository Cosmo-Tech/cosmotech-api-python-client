...
class PlatformService(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """PlatformService - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            options ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): the service specific options. [optional]  # noqa: E501
        """
