...
class WorkspaceSecurity(ModelNormal):
    ...
    def _from_openapi_data(cls, default, access_control_list, *args, **kwargs):  # noqa: E501
        """WorkspaceSecurity - a model defined in OpenAPI

        Args:
            default (str): the role by default
            access_control_list ([RbacAccessControl]): the list which can access this Workspace with detailed access control information
