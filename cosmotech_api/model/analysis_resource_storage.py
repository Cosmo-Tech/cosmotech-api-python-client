...
class AnalysisResourceStorage(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, storage_type, _resource_path, *args, **kwargs):  # noqa: E501
        """AnalysisResourceStorage - a model defined in OpenAPI
