...
class RunnerSecurity(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'access_control_list': ([RunnerAccessControl],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, default, access_control_list, *args, **kwargs):  # noqa: E501
        """RunnerSecurity - a model defined in OpenAPI

        Args:
            default (str): the role by default
            access_control_list ([RunnerAccessControl]): the list which can access this Runner with detailed access control information
