...
class DatasetApi:
    ...
    def get_dataset_members(
        ...
        _param = self._get_dataset_members_serialize(
            organization_id=organization_id,
            workspace_id=workspace_id,
            dataset_id=dataset_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_dataset_members_with_http_info(
        self,
        organization_id: Annotated[str, Field(strict=True, description="the Organization identifier")],
        workspace_id: Annotated[str, Field(strict=True, description="the Workspace identifier")],
        dataset_id: Annotated[str, Field(strict=True, description="the Dataset identifier")],
    ...
    @validate_call
    def get_dataset_members_without_preload_content(
        self,
        organization_id: Annotated[str, Field(strict=True, description="the Organization identifier")],
        workspace_id: Annotated[str, Field(strict=True, description="the Workspace identifier")],
        dataset_id: Annotated[str, Field(strict=True, description="the Dataset identifier")],
    ...
    def _get_dataset_members_serialize(
        self,
        organization_id,
        workspace_id,
        dataset_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/organizations/{organization_id}/workspaces/{workspace_id}/datasets/{dataset_id}/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
