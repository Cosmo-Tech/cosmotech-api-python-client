...
class SolutionApi:
    ...
    def get_solution_members(
        ...
        _param = self._get_solution_members_serialize(
            organization_id=organization_id,
            solution_id=solution_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_solution_members_with_http_info(
        self,
        organization_id: Annotated[str, Field(strict=True, description="the Organization identifier")],
        solution_id: Annotated[str, Field(strict=True, description="the Solution identifier")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_solution_members_without_preload_content(
        self,
        organization_id: Annotated[str, Field(strict=True, description="the Organization identifier")],
        solution_id: Annotated[str, Field(strict=True, description="the Solution identifier")],
        _request_timeout: Union[
    ...
    def _get_solution_members_serialize(
        self,
        organization_id,
        solution_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/organizations/{organization_id}/solutions/{solution_id}/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
