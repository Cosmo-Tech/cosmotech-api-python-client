...
class ScenariorunApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_historical_data_organization_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'delete_unknown': 'deleteUnknown',
                },
                'location_map': {
                    'organization_id': 'path',
                    'delete_unknown': 'query',
                },
        ...
        self.delete_historical_data_scenario_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'oAuth2AuthCode'
                ],
                'endpoint_path': '/organizations/{organization_id}/workspaces/{workspace_id}/scenarios/{scenario_id}/scenarioruns/historicaldata',
                'operation_id': 'delete_historical_data_scenario',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def delete_historical_data_scenario(
        ...
        **kwargs
        ...
        >>> thread = api.delete_historical_data_scenario(organization_id, workspace_id, scenario_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['scenario_id'] = \
            scenario_id
        return self.delete_historical_data_scenario_endpoint.call_with_http_info(**kwargs)
