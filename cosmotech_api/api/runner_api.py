...
class RunnerApi:
    ...
    def get_runner_members(
        ...
        _param = self._get_runner_members_serialize(
            organization_id=organization_id,
            workspace_id=workspace_id,
            runner_id=runner_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_runner_members_with_http_info(
        self,
        organization_id: Annotated[str, Field(strict=True, description="the Organization identifier")],
        workspace_id: Annotated[str, Field(strict=True, description="the Workspace identifier")],
        runner_id: Annotated[str, Field(strict=True, description="the Runner identifier")],
    ...
    @validate_call
    def get_runner_members_without_preload_content(
        self,
        organization_id: Annotated[str, Field(strict=True, description="the Organization identifier")],
        workspace_id: Annotated[str, Field(strict=True, description="the Workspace identifier")],
        runner_id: Annotated[str, Field(strict=True, description="the Runner identifier")],
    ...
    def _get_runner_members_serialize(
        self,
        organization_id,
        workspace_id,
        runner_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/organizations/{organization_id}/workspaces/{workspace_id}/runners/{runner_id}/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
