...
class ScenarioLastRun(BaseModel):
    """
    ScenarioLastRun
    """ # noqa: E501
    scenario_run_id: Optional[StrictStr] = Field(default=None, description="the last Scenario Run id", alias="scenarioRunId")
    ...
    __properties: ClassVar[List[str]] = ["scenarioRunId", "csmSimulationRun", "workflowId", "workflowName"]
