...
class Workspace(BaseModel):
    ...
    owner_id: StrictStr = Field(description="the user id which own this workspace. set by the API from Authentification service receved id", alias="ownerId")
    ...
    __properties: ClassVar[List[str]] = ["id", "organizationId", "key", "name", "description", "linkedDatasetIdList", "version", "tags", "ownerId", "solution", "webApp", "datasetCopy", "security"]
