...
class Workspace(BaseModel):
    ...
    A Workspace
    """ # noqa: E501
    id: Annotated[str, Field(strict=True)] = Field(description="Workspace unique identifier generated by the API", json_schema_extra={"examples": ["w-0123456789ab"]})
    organization_id: Annotated[str, Field(strict=True)] = Field(description="Organization unique identifier under which the workspace resides", alias="organizationId", json_schema_extra={"examples": ["o-0123456789ab"]})
    key: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Technical key for resource name convention and version grouping. Must be unique", json_schema_extra={"examples": ["MyKey"]})
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Workspace name. This name is display in the sample webApp", json_schema_extra={"examples": ["FranceOffice"]})
