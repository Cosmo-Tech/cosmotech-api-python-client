...
class WorkspaceMembers(BaseModel):
    ...
    """ # noqa: E501
    users: List[WorkspaceMemberUser] = Field(description="The list of users in the workspace")
    groups: List[WorkspaceMemberGroup] = Field(description="The list of groups in the workspace")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [WorkspaceMemberUser.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
            "groups": [WorkspaceMemberGroup.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
