...
class DatasetSecurity(BaseModel):
    ...
    access_control_list: List[DatasetAccessControl] = Field(description="the list which can access this Dataset with detailed access control information", alias="accessControlList")
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.access_control_list:
            for _item_access_control_list in self.access_control_list:
                _items.append(_item_access_control_list.to_dict() if _item_access_control_list is not None else None)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accessControlList": [DatasetAccessControl.from_dict(_item) for _item in obj["accessControlList"]] if obj.get("accessControlList") is not None else None
        })
        return _obj
